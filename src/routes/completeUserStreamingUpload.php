<?php
$app->post('/api/Vimeo/completeUserStreamingUpload', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['accessToken', 'ticketId', 'signature', 'videoFileId']);
